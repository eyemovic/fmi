...
<div class="l-contents">
  <main class="l-main is-xs-noPad">
	...
	<?php if(have_posts()): ?>
        <h2 class="l-ttl-sm">「<?php echo $term->name; ?>」のレシピ<span class="recipe-archive__postsnum">（全<?php echo $wp_query->found_posts; ?>件　<strong><?php echo $paged; ?></strong>ページ目 / <?php echo $wp_query->max_num_pages; ?>ページ中表示）</span></h2>
